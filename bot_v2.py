...
USER_TOKEN     = os.environ.get("NzU0MTY1NDYxNDkwNDY2ODU4.GoiAxH.EZ18xNeVmFvydw5uGgi2D57UfDX0wSnKyFC1ls")
GMAIL_SENDER   = os.environ.get("brunomazzalomo@gmail.com")
GMAIL_PASSWORD = os.environ.get("nalaysimon")
EMAIL_DESTINO  = os.environ.get("brunomazzalomo@gmail.com")

CHANNEL_IDS = {
    "resale-category-1": os.environ.get("1482089222780223538"),
    "resale-category-2": os.environ.get("1482173264011989075"),
    "resale-category-3": os.environ.get("1482173290847010826"),
    "resale-category-4": os.environ.get("1482173318021910588"),
}
